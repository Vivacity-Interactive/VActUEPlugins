...
public:
	...
	//bool Options(TArray<FBeatPointPrototype>& Into, const FBeatEntity& Entity, const FBeatVector& Vector, int32 K = -1);

	//bool Options(TArray<FBeatPointPrototype>& Into, const FBeatVector& Vector, int32 K = -1);

	//bool Options(TArray<FBeatPointPrototype>& Into, const FBeatEntity& Entity, const FBeatVector& Vector, float Radius, int32 K = -1);

	//bool Options(TArray<FBeatPointPrototype>& Into, const FBeatVector& Vector, float Radius, int32 K = -1);
