...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnBeatChanged, const FGlobalBeatState&, GlobalBeatState);
...
public:
	...
	FORCEINLINE UBeatPool* GetActiveScenario()
	{
