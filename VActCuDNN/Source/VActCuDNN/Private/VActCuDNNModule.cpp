...
void FVActCuDNNModule::StartupModule()
{
	...
	//FVActCuDNNTests::_Debug_Cuda_Test();
	//FVActCuDNNTests::_Debug_CuDNN_Test_0();
	//FVActCuDNNTests::_Debug_CuDNN_Test_1();
	//FVActCuDNNTests::_Debug_VActCuDNN_Test_0();
	//FVActCuDNNTests::_Debug_VActCuDNN_Test_1();
#endif;
}
